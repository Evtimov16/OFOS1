<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyOrders.aspx.cs" Inherits="DemoPro.MyAccount" %>
...
<body>
    <center>
        <form id="form1" runat="server">    
            ...
            <asp:Button CssClass="b1" Text="Върни се" ID="btn_back" runat="server" OnClick="goBack_click" />
