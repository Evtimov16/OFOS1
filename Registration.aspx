...
<body style="background-color:#4df0d6;">
    ...
    <p style=" text-align:right" >
        ...
        <br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
          ...
          <table border="0" >
            <tr>
              <td style="text-align:right"><asp:Label ID="Label1" runat="server" Text="Потребителско име : "></asp:Label></td>
            ...
            <tr>
                <td style="text-align:right"><asp:Label ID="Label2" runat="server" Text="Име : "></asp:Label></td>
                <td style="text-align:left"><asp:TextBox ID="tb_name" runat="server"></asp:TextBox></td>
            </tr>
              <tr><td></td></tr><tr><td></td></tr>
            <tr>
                <td style="text-align:right"><asp:Label ID="Label3" runat="server" Text="Парола : "></asp:Label></td>
            ...
            <tr>
                <td style="text-align:right"><asp:Label ID="Label4" runat="server" Text="Въведи отново паролата : "></asp:Label></td>
            ...
            <tr>
                <td style="text-align:right"><asp:Label ID="Label5" runat="server" Text="E-mail : "></asp:Label></td>
        ...
        <tr>
            <td style="text-align:right"><asp:Label ID="Label6" runat="server" Text="Телефон : "></asp:Label></td>
        ...
        <tr>
            <td style="text-align:right"><asp:Label ID="Label7" runat="server" Text="Номер : "></asp:Label></td>
        ...
        <tr>
            <td style="text-align:right"><asp:Label ID="Label8" runat="server" Text="Улица:"></asp:Label></td>
            <td style="text-align:left"><asp:TextBox ID="tb_street" runat="server"></asp:TextBox></td>
        </tr>
              <tr><td></td></tr><tr><td></td></tr>
        <tr>
            <td style="text-align:right"><asp:Label ID="Label9" runat="server" Text="Град:"></asp:Label></td>
            ...
            <br /><br />
        <asp:Button ID="Button1_register" runat="server" Text="Регистрирай се" OnClick="Button1_register_Click" />
        <br />
               </div>
    </form>
