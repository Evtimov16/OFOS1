...
<body>
    <form id="form1" runat="server">
        ...
        <center><font size="7" color="#47a9c2"><b><u> ONLINE TRANSACTION</u></b></font> 
            <p> &nbsp;</p>
       <h3><b><asp:Label ID="Label1" runat="server" Text="" ForeColor="white"></asp:Label></b></h3>
        </center>  <b> <font color="#47a9c2">
        <p> &nbsp;</p>
        ...
        <center>
            <asp:Button ID="Button1" runat="server" Text="Плащане" OnClick="Button1_Click" 
                 CssClass="button button2" />
            <asp:Button ID="Button2" runat="server" Text="Премини на плащане в брой" OnClick="Button2_Click" 
