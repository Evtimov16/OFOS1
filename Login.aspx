...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br /><br /><br />
            <center>
                <asp:Button Text="Регистриран потребител" runat="server" Width="232px" OnClick="user_click" CssClass="b4" CausesValidation="false" />
                <asp:Button Text="Гост" runat="server" Width="232px" OnClick="guest_click" CssClass="b4" CausesValidation="false"/>
                <br /><br />
            ...
            <tr>
                ...
                <br />
                &emsp;
            <asp:Button ID="button_login" runat="server" Text="Вход" OnClick="Login_Click" CssClass="button button2" Width="160px"></asp:Button>
        <asp:HyperLink ID="link_regi" runat="server" NavigateUrl="~/Registration.aspx" CssClass="button button2" Text="Създай акаунт"/>
                </div>
       ...
       <table cellpadding="20" style="align-items:center">
        ...
        <tr>
            ...
            <asp:Button ID="Button1_register" runat="server" Text="Готово" 
