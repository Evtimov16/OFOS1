...
<body>
    ...
    <br />
        ...
        <p style="margin-left: 100px">
            ...
            <asp:Button ID="Button1" runat="server" CssClass="btn " Height="31px" Text="Добави елементи" Width="253px" OnClick="Button1_Click" />
        </p>
                    <br />
        <p style="margin-left: 100px">

            <asp:Button ID="Button2" runat="server" CssClass="btn"  Height="31px" Text="Промени менюто" Width="252px" OnClick="Button2_Click" />
        </p>
